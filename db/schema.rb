...
ActiveRecord::Schema[7.1].define(version: 2024_11_28_035857) do
  ...
  create_table "students", primary_key: "student_id", id: :string, force: :cascade do |t|
    ...
    t.float "physics", default: 0.0
    t.float "chemical", default: 0.0
    t.float "biology", default: 0.0
    t.float "history", default: 0.0
    t.float "geography", default: 0.0
    t.float "civic_education", default: 0.0
